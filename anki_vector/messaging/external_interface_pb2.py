...
_PROTOCOLVERSION = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PROTOCOL_VERSION_CURRENT', index=2, number=3,
      options=None,
      type=None),
  ],
